...
export type DeliveryMethodFragmentFragment = { __typename?: 'ShippingMethod', id: string, name: string, minimumDeliveryDays?: number | null, maximumDeliveryDays?: number | null, price: { __typename?: 'Money', currency: string, amount: number } };
...
export type FetchAllCategoriesQuery = { __typename?: 'Query', categories?: { __typename?: 'CategoryCountableConnection', edges: Array<{ __typename?: 'CategoryCountableEdge', node: { __typename?: 'Category', id: string, name: string } }> } | null };
...
export const FetchAllCategoriesDocument = gql`
    query FetchAllCategories($num: Int = 5) {
  categories(first: $num, level: 0) {
    edges {
      node {
        id
        name
